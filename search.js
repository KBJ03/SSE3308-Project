      ...
      .then(data => {
         if(data.success){
          results = data.results;
            ...
            heading.classList.add('p-3', 'text-white', 'd-flex', 'text-align-center');
            heading.innerText = results.length + ' Search Results';
            ...
            for(let j = 0 ; j<results.length; j++){
              ...
              link.href = 'product detail.html?MemberID=' + id + '&ItemId=' + results[j]['ItemID'];
          ...
          heading1.classList.add('p-3', 'text-white', 'd-flex', 'text-align-center');
          heading1.innerHTML = 'There are no search results. Please try another search term';
          searchResult.appendChild(heading1);
